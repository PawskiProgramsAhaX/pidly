...
export default function AddSubclassDialog({ show, onClose, onSubmit, selectedClassName }) {
  ...
  return (
    <div className="modal-overlay" onClick={handleClose}>
      <div className="modal" onClick={(e) => e.stopPropagation()} style={{ maxWidth: '400px' }}>
        ...
        <p style={{ color: '#888', fontSize: '13px', margin: '0 0 20px' }}>Add a subclass column to "{selectedClassName}"</p>
        <div style={{ marginBottom: '20px' }}>
          <label style={{ display: 'block', color: '#fff', fontWeight: 600, fontSize: '13px', marginBottom: '8px' }}>Subclass Name</label>
          <input
            type="text"
